...
mixin _$Sale {
 ...
 String get id; String? get number;@JsonKey(name: 'customer_id') String? get customerId;@JsonKey(name: 'customer_name') String? get customerName; String get status;// 'concluida' | 'cancelada'
@JsonKey(name: 'payment_method') String get paymentMethod;// 'dinheiro' | 'cartao' | 'pix' | 'outro'
 String get discount; String get subtotal; String get total;@JsonKey(name: 'stock_applied') bool get stockApplied;@JsonKey(name: 'created_at') String? get createdAt;@JsonKey(name: 'canceled_at') String? get canceledAt;// Preenchido só em GET /sales/:id (detalhe).
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sale&&(identical(other.id, id) || other.id == id)&&(identical(other.number, number) || other.number == number)&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.status, status) || other.status == status)&&(identical(other.paymentMethod, paymentMethod) || other.paymentMethod == paymentMethod)&&(identical(other.discount, discount) || other.discount == discount)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.total, total) || other.total == total)&&(identical(other.stockApplied, stockApplied) || other.stockApplied == stockApplied)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.canceledAt, canceledAt) || other.canceledAt == canceledAt)&&const DeepCollectionEquality().equals(other.items, items));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,number,customerId,customerName,status,paymentMethod,discount,subtotal,total,stockApplied,createdAt,canceledAt,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'Sale(id: $id, number: $number, customerId: $customerId, customerName: $customerName, status: $status, paymentMethod: $paymentMethod, discount: $discount, subtotal: $subtotal, total: $total, stockApplied: $stockApplied, createdAt: $createdAt, canceledAt: $canceledAt, items: $items)';
}
...
@useResult
$Res call({
 String id, String? number,@JsonKey(name: 'customer_id') String? customerId,@JsonKey(name: 'customer_name') String? customerName, String status,@JsonKey(name: 'payment_method') String paymentMethod, String discount, String subtotal, String total,@JsonKey(name: 'stock_applied') bool stockApplied,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'canceled_at') String? canceledAt, List<SaleItem> items
});
...
/// Create a copy of Sale
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? number = freezed,Object? customerId = freezed,Object? customerName = freezed,Object? status = null,Object? paymentMethod = null,Object? discount = null,Object? subtotal = null,Object? total = null,Object? stockApplied = null,Object? createdAt = freezed,Object? canceledAt = freezed,Object? items = null,}) {
...
as String,stockApplied: null == stockApplied ? _self.stockApplied : stockApplied // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? number, @JsonKey(name: 'customer_id')  String? customerId, @JsonKey(name: 'customer_name')  String? customerName,  String status, @JsonKey(name: 'payment_method')  String paymentMethod,  String discount,  String subtotal,  String total, @JsonKey(name: 'stock_applied')  bool stockApplied, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'canceled_at')  String? canceledAt,  List<SaleItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sale() when $default != null:
return $default(_that.id,_that.number,_that.customerId,_that.customerName,_that.status,_that.paymentMethod,_that.discount,_that.subtotal,_that.total,_that.stockApplied,_that.createdAt,_that.canceledAt,_that.items);case _:
  return orElse();
...
class _Sale implements Sale {
  const _Sale({required this.id, this.number, @JsonKey(name: 'customer_id') this.customerId, @JsonKey(name: 'customer_name') this.customerName, this.status = 'concluida', @JsonKey(name: 'payment_method') this.paymentMethod = 'dinheiro', this.discount = '0', this.subtotal = '0', this.total = '0', @JsonKey(name: 'stock_applied') this.stockApplied = false, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'canceled_at') this.canceledAt, final  List<SaleItem> items = const <SaleItem>[]}): _items = items;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sale&&(identical(other.id, id) || other.id == id)&&(identical(other.number, number) || other.number == number)&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.status, status) || other.status == status)&&(identical(other.paymentMethod, paymentMethod) || other.paymentMethod == paymentMethod)&&(identical(other.discount, discount) || other.discount == discount)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.total, total) || other.total == total)&&(identical(other.stockApplied, stockApplied) || other.stockApplied == stockApplied)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.canceledAt, canceledAt) || other.canceledAt == canceledAt)&&const DeepCollectionEquality().equals(other._items, _items));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,number,customerId,customerName,status,paymentMethod,discount,subtotal,total,stockApplied,createdAt,canceledAt,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of Sale
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? number = freezed,Object? customerId = freezed,Object? customerName = freezed,Object? status = null,Object? paymentMethod = null,Object? discount = null,Object? subtotal = null,Object? total = null,Object? stockApplied = null,Object? createdAt = freezed,Object? canceledAt = freezed,Object? items = null,}) {
  return _then(_Sale(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,number: freezed == number ? _self.number : number // ignore: cast_nullable_to_non_nullable
as String?,customerId: freezed == customerId ? _self.customerId : customerId // ignore: cast_nullable_to_non_nullable
...
mixin _$SaleItem {
 ...
 String get id;@JsonKey(name: 'inventory_item_id') String? get inventoryItemId; String get kind;// 'product' | 'service'
 String get name; String get quantity;@JsonKey(name: 'unit_price') String get unitPrice; String get discount; String get total;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,inventoryItemId,kind,name,quantity,unitPrice,discount,total);

@override
String toString() {
  return 'SaleItem(id: $id, inventoryItemId: $inventoryItemId, kind: $kind, name: $name, quantity: $quantity, unitPrice: $unitPrice, discount: $discount, total: $total)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'inventory_item_id') String? inventoryItemId, String kind, String name, String quantity,@JsonKey(name: 'unit_price') String unitPrice, String discount, String total
});
...
/// Create a copy of SaleItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? inventoryItemId = freezed,Object? kind = null,Object? name = null,Object? quantity = null,Object? unitPrice = null,Object? discount = null,Object? total = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'inventory_item_id')  String? inventoryItemId,  String kind,  String name,  String quantity, @JsonKey(name: 'unit_price')  String unitPrice,  String discount,  String total)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleItem() when $default != null:
return $default(_that.id,_that.inventoryItemId,_that.kind,_that.name,_that.quantity,_that.unitPrice,_that.discount,_that.total);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'inventory_item_id')  String? inventoryItemId,  String kind,  String name,  String quantity, @JsonKey(name: 'unit_price')  String unitPrice,  String discount,  String total)  $default,) {final _that = this;
switch (_that) {
case _SaleItem():
return $default(_that.id,_that.inventoryItemId,_that.kind,_that.name,_that.quantity,_that.unitPrice,_that.discount,_that.total);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'inventory_item_id')  String? inventoryItemId,  String kind,  String name,  String quantity, @JsonKey(name: 'unit_price')  String unitPrice,  String discount,  String total)?  $default,) {final _that = this;
switch (_that) {
case _SaleItem() when $default != null:
return $default(_that.id,_that.inventoryItemId,_that.kind,_that.name,_that.quantity,_that.unitPrice,_that.discount,_that.total);case _:
  return null;
...
class _SaleItem implements SaleItem {
  const _SaleItem({required this.id, @JsonKey(name: 'inventory_item_id') this.inventoryItemId, this.kind = 'product', required this.name, this.quantity = '1', @JsonKey(name: 'unit_price') this.unitPrice = '0', this.discount = '0', this.total = '0'});
...
/// Create a copy of SaleItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? inventoryItemId = freezed,Object? kind = null,Object? name = null,Object? quantity = null,Object? unitPrice = null,Object? discount = null,Object? total = null,}) {
