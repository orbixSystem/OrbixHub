...
mixin _$Sale {
 ...
 String get discount;@JsonKey(name: 'fiscal_status') String? get fiscalStatus;// 'a_receber' | 'parcial' | 'pago' | 'cancelada' (flat, espelha payment.status)
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,number,customerId,customerName,status,total,discount,fiscalStatus,paymentStatus,createdAt,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'Sale(id: $id, number: $number, customerId: $customerId, customerName: $customerName, status: $status, total: $total, discount: $discount, fiscalStatus: $fiscalStatus, paymentStatus: $paymentStatus, createdAt: $createdAt, items: $items)';
}
...
@useResult
$Res call({
 String id, String number,@JsonKey(name: 'customer_id') String? customerId,@JsonKey(name: 'customer_name') String? customerName, String status, String total, String discount,@JsonKey(name: 'fiscal_status') String? fiscalStatus,@JsonKey(name: 'payment_status') String paymentStatus,@JsonKey(name: 'created_at') String? createdAt, List<SaleItem> items
});
...
/// Create a copy of Sale
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? number = null,Object? customerId = freezed,Object? customerName = freezed,Object? status = null,Object? total = null,Object? discount = null,Object? fiscalStatus = freezed,Object? paymentStatus = null,Object? createdAt = freezed,Object? items = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String number, @JsonKey(name: 'customer_id')  String? customerId, @JsonKey(name: 'customer_name')  String? customerName,  String status,  String total,  String discount, @JsonKey(name: 'fiscal_status')  String? fiscalStatus, @JsonKey(name: 'payment_status')  String paymentStatus, @JsonKey(name: 'created_at')  String? createdAt,  List<SaleItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sale() when $default != null:
return $default(_that.id,_that.number,_that.customerId,_that.customerName,_that.status,_that.total,_that.discount,_that.fiscalStatus,_that.paymentStatus,_that.createdAt,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String number, @JsonKey(name: 'customer_id')  String? customerId, @JsonKey(name: 'customer_name')  String? customerName,  String status,  String total,  String discount, @JsonKey(name: 'fiscal_status')  String? fiscalStatus, @JsonKey(name: 'payment_status')  String paymentStatus, @JsonKey(name: 'created_at')  String? createdAt,  List<SaleItem> items)  $default,) {final _that = this;
switch (_that) {
case _Sale():
return $default(_that.id,_that.number,_that.customerId,_that.customerName,_that.status,_that.total,_that.discount,_that.fiscalStatus,_that.paymentStatus,_that.createdAt,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,number,customerId,customerName,status,total,discount,fiscalStatus,paymentStatus,createdAt,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of Sale
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? number = null,Object? customerId = freezed,Object? customerName = freezed,Object? status = null,Object? total = null,Object? discount = null,Object? fiscalStatus = freezed,Object? paymentStatus = null,Object? createdAt = freezed,Object? items = null,}) {
  return _then(_Sale(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,number: null == number ? _self.number : number // ignore: cast_nullable_to_non_nullable
as String,customerId: freezed == customerId ? _self.customerId : customerId // ignore: cast_nullable_to_non_nullable
