...
void main() {
  ...
  // O grupo "OS em fiado" foi REMOVIDO junto com o recurso: o redesign do caixa
  // (6d45e34) tirou a OS pendente da linha do tempo — ela passou a vir direto
  // do módulo de OS, e `buildCashierTimeline` não recebe mais `osTitles`.
  //
  // O que esses testes protegiam e ficou SEM cobertura equivalente: a OS a
  // receber aparecer na lista mesmo sem ter movido o caixa, o recebimento
  // parcial não duplicar a OS já listada, e um título de VENDA não virar linha
  // de OS. Se a OS pendente voltar à timeline, estes casos precisam voltar
  // junto — foram eles que pegaram a duplicação da primeira vez.
